...
public class CardView : MonoBehaviour
{
    ...
    [SerializeField] private TMP_Text descriptrion;
    ...
    public void Setup(Card card)
    {
        ...
        descriptrion.text = card.Description;
    ...
    void OnMouseDown()
    {
        ...
        if(Card.ManualTargerEffect != null)
        {
    ...
    {
        if (!Interactions.Instance.PlayerCanInteract()) return;
        if(Card.ManualTargerEffect != null) return;
        transform.position = MouseUtil.GetMousePositionInWorldSpace(-1);
    }
    ...
    void OnMouseUp()
    {
        ...
        if (Card.ManualTargerEffect != null)
        {
            ...
            {
                PlayCardGA playerCardGA = new(Card, target);
